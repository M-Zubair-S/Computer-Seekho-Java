...
const [selectedStaffId, setSelectedStaffId] = useState("");
  ...
  const validate = () => {
    ...
    if (!reg.enquirer_name) {
      validationErrors.enquirer_name = "First name is required";
    }
    ...
    var phnum = /^[7-9]\d{9}$/;
    if (!customerMasterDetails.phoneNo) {
      validationErrors.phoneNo = "Phone number is required";
    } else if (!phnum.test(customerMasterDetails.phoneNo)) {
      validationErrors.phoneNo = "Phone number is not valid";
    }
